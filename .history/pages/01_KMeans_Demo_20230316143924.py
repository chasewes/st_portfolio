...
st.write("Now we will repeat the process of assigning points to centroids and recalculating the centroids until the centroids stop moving. I will visualize ")
