...
fig, ax = plt.subplots()
ax.scatter(data[:,0], data[:,1])
#add the centroids to the plot, give each centroid a different color (based on index), make the centroid points x's
ax.scatter(centroids[:,0], centroids[:,1], c=color_map, marker='x')
